function [numero_respuesta]=clasificacion_Saber1011_nuevo(pregunta, opciones,Numero_pregunta,corte)  

% para recortar mas de las preguntas que tienen mas opciones

if corte==4
     if Numero_pregunta== 6 || Numero_pregunta== 7 || Numero_pregunta== 8 || Numero_pregunta== 9 || Numero_pregunta== 10 
        opciones = 8;
