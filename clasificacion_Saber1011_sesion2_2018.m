function [numero_respuesta]=clasificacion_Saber1011_sesion2_2018(pregunta, opciones,Numero_pregunta,corte)  

% para recortar mas de las preguntas que tienen mas opciones

if corte==4
    
     if Numero_pregunta== 15 || Numero_pregunta== 16 || Numero_pregunta== 17 || Numero_pregunta== 18 || Numero_pregunta== 19 
        %disp(Numero_pregunta)
        opciones = 8;
